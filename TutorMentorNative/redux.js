...
export const apiMiddleware = store => next => action => {
  ...
  switch (action.type) {
    ...
    case 'GET_PEOPLE_DATA':
      // Dispatch GET_PEOPLE_DATA_LOADING to update loading state
...
export const reducer = (state = { persons: [], loading: true }, action) => {
    switch (action.type) {
      ...
      case 'GET_PEOPLE_DATA_RECEIVED':
        return {
          ...
          persons: action.data.persons, // update movies array with reponse data
        };
